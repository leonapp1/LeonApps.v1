    ...
    <section className="relative overflow-hidden pt-10 pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-br from-blue-50 to-white">
      ...
      <Container className="relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <Typography variant="small" className="font-bold text-primary mb-4 block uppercase tracking-wider">
              Soluciones Digitales
            </Typography>
            <Typography variant="h1" className="mb-6 leading-tight">
              Impulsa tu negocio con <span className="text-primary">soluciones creativas</span> y efectivas
            </Typography>
            <Typography variant="body" className="mb-8 text-slate-600">
              Te ayudamos a destacar con páginas web modernas, marketing estratégico y tecnología a tu medida. Transformamos ideas en éxito digital.
            </Typography>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl bg-slate-200 aspect-[4/3] flex items-center justify-center group">
