...
const steps = [
	...
	},
	{
		...
		description:
			"Nos contactamos contigo para conocer más sobre tu proyecto y definir objetivos.",
	},
	{
		number: 3,
		title: "Desarrollo del proyecto",
		description:
			"Trabajamos en la creación de tu solución con actualizaciones regulares.",
	},
	{
		number: 4,
		title: "Revisión y ajustes",
		description:
			"Te presentamos el resultado final y realizamos los ajustes necesarios.",
	},
	{
		number: 5,
		title: "Entrega Final",
		description:
			"Recibe tu proyecto listo para usar, junto con el soporte que necesites.",
	},
];
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden flex items-center justify-center">
              <img src="./ProcessPerson.png" alt="" />
					...
					<div>
						...
						<Typography
							variant="body"
							className="mb-12 text-slate-600"
						>
							Para llevar tu proyecto al siguiente nivel de la
