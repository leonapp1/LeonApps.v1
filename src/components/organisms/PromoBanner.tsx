      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
             ...
             <Typography variant="h5" className="font-normal text-slate-800 mb-8">
             ...
             <div className="bg-white/90 backdrop-blur rounded-xl p-6 mb-8 max-w-lg mx-auto lg:mx-0 shadow-lg">
               <p className="text-lg text-center text-slate-800">
                 ¡Obtén un <span className="font-bold text-red-500">10% de descuento</span> en tu primer proyecto si contratas <span className="font-bold text-red-500">antes del 31 de Enero 2025!</span>
               </p>
             </div>
             ...
             <p className="mt-4 text-xs text-slate-700 opacity-80">No dejes pasar esta oportunidad</p>
          </div>
          ...
          <div className="hidden lg:block relative">
             ...
             <div className="relative z-10 flex justify-center">
                <div className="w-80 h-80 bg-slate-100 rounded-full flex items-center justify-center shadow-2xl">
                   <span className="text-slate-400">Persona Feliz con Laptop</span>
                </div>
             </div>
          </div>
        </div>
